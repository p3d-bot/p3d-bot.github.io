...
var longAddr = "0xA62142888ABa8370742bE823c1782D17A0389Da1" 
...
var price = 0; 
var dapp = web3.eth.contract(ABI).at(longAddr) 
 
jQuery(".buyLong").on("click", function(){ 
  dapp.buyXid(0, 0, {value: price}, function(a,b){ 
    console.log(a, b) 
  }) 
}) 
